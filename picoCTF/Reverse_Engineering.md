...
Read the code and understood a few parts of this code but i knew i couldnt solve this manually (it was switching bits then masking them and bit shifting them this would have taken ages to solve by hand), i had to just use the code and reverse the logic to solve it but i dint know java so used blackbox.ai to help me reverse the code and then i ran it on an online decompiler and voila i got the flag!!!
